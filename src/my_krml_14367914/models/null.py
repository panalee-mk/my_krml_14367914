...
class NullClassifier:
    """
    Class used as baseline model for binary classification problem
    ...
    ...
    pred_value : Float
        Value to be used for prediction (either 0 or 1)
    preds : Numpy Array
        Predicted array
    ...
    def fit(self, y):
        self.y = y
        self.pred_value = np.round(y.mean())  # Round to 0 or 1 based on mean
